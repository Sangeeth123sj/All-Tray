...
urlpatterns = [
    ...
    path('store_edit_details_post/', views.store_edit_details_post, name='store_edit_details_post'),
    ...
    path('ajax/update_item_availability/', views.update_item_availability, name = 'update_item_availability'),
    ...
    path('ajax/store_login_validate/', views.store_login_validate, name='store_login_validate'),
    path('ajax/college_login_validate/', views.college_login_validate, name='college_login_validate'),
    path('ajax/store_register_validate/', views.store_register_validate, name='store_register_validate'),
    path('ajax/college_register_validate/', views.college_register_validate, name='college_register_validate'),
